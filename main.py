...
switch_var = customtkinter.StringVar(value="Scuro")
switch = customtkinter.CTkSwitch(app, text="", command=lambda: set_tema(switch_var.get()),
                                 variable=switch_var, onvalue="Scuro", offvalue="Chiaro")
testo_tema = customtkinter.CTkLabel(app, text="",image=icon_theme)
...
testo_tema.grid(row=0, column=1)
button_invio_modem.grid(row=1, column=3, padx=10, pady=10)
